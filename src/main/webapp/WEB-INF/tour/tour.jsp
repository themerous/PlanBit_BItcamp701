...
<div id="tourMain" class="tourMain">
	...
	<%--		<img src="/images/koreaMap.png" alt="Image Korea" style="">--%>
			...
			<input name="s" id="busan" type="radio" value="6" onclick="setArea(this.value)">
			<label for="busan">부산</label>
			<input name="s" id="daegu" type="radio" value="4" onclick="setArea(this.value)">
			<label for="daegu">대구</label>
			<input name="s" id="incheon" type="radio" value="2" onclick="setArea(this.value)">
			<label for="incheon">인천</label>
			<input name="s" id="gwangju" type="radio" value="5" onclick="setArea(this.value)">
			<label for="gwangju">광주</label>
			<input name="s" id="daejeon" type="radio" value="3" onclick="setArea(this.value)">
			<label for="daejeon">대전</label>
			<input name="s" id="ulsan" type="radio" value="7" onclick="setArea(this.value)">
			<label for="ulsan">울산</label>
			<input name="s" id="sejong" type="radio" value="8" onclick="setArea(this.value)">
			<label for="sejong">세종</label>
			<input name="s" id="gyeonggi" type="radio" value="31" onclick="setArea(this.value)">
			<label for="gyeonggi">경기</label>
			<input name="s" id="gangwon" type="radio" value="32" onclick="setArea(this.value)">
			<label for="gangwon">강원</label>
			<input name="s" id="chungbuk" type="radio" value="33" onclick="setArea(this.value)">
			<label for="chungbuk">충북</label>
			<input name="s" id="chungnam" type="radio" value="34" onclick="setArea(this.value)">
			<label for="chungnam">충남</label>
			<input name="s" id="gyeongbuk" type="radio" value="35" onclick="setArea(this.value)">
			<label for="gyeongbuk">경북</label>
			<input name="s" id="gyeongnam" type="radio" value="36" onclick="setArea(this.value)">
			<label for="gyeongnam">경남</label>
			<input name="s" id="jeonbuk" type="radio" value="37" onclick="setArea(this.value)">
			<label for="jeonbuk">전북</label>
			<input name="s" id="jeonnam" type="radio" value="38" onclick="setArea(this.value)">
			<label for="jeonnam">전남</label>
			<input name="s" id="jeju" type="radio" value="39" onclick="setArea(this.value)">
